@if($content = trim($this->__module->getContent()))
	...
	@endphp 
	<div id="module{{ $this->__module->get('id') }}" class="module {{ implode(' ', $columns) }} {{ $this->__module->config('_floating') }} {{ $this->__module->config('_direction') }} {{ $this->__module->config('_align') }} 
