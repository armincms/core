...
<head>
	...
	<title>ArminCms | Installer</title>
	<meta name="description" content="ArminCms | Installer">
	<meta name="author" content="ArminCms">
...
<body dir="rtl" class="full-page-wizard"> 
	@yield('main')
	...
	<script src="/admin/rtl/js/developr.wizard.js"></script>

	<!-- jQuery Form Validation -->
	{{-- <script src="/admin/rtl/js/libs/formValidator/jquery.validationEngine.js?v=1"></script>
	<script src="/admin/rtl/js/libs/formValidator/languages/jquery.validationEngine-fa.js?v=1"></script> --}}
